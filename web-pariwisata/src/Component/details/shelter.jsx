...
import '../../App.css';
import tj1 from "../../Images/shelter/1.jpg"
import tj2 from "../../Images/shelter/2.jpeg"
import tj3 from "../../Images/shelter/3.jpeg"
import tj8 from "../../Images/shelter/5.jpg"
import tj9 from "../../Images/shelter/6.jpg"
import tj5 from "../../Images/shelter/sh.jpg"
...
<>
        <section style={{
            ...
            <div className='flex flex-col gap-5 iphone:gap-3  items-end px-[10%]'>
              <h1 className='font-extrabold text-9xl tablet-sm:text-7xl android:text-6xl android-sm:text-4xl iphone:text-3xl'>SHELTER</h1>
        ...
        <div style={{
          ...
          <div className='bg-[#004194] p-10 bg-opacity-40 tablet:h-full'>
            <h1 className=' font-bold'>SHELTER</h1>
            <h2 className=' ml-5 mt-3 iphone:mt-0'>GALUNGGUNG</h2>
          </div>
        </div>
        <div className='w-[70vw] tablet:w-full h-[100vh]  py-[10%] px-[10%] text-[#505050]'>
              <h1 className='text-6xl mb-2 title font-semibold text-[#137fb8] tablet-sm:text-5xl android:text-4xl android-sm:text-2xl iphone:text-xl'>SHELTER</h1>
              <p className='text-3xl tablet-sm:text-xl android:text-lg android-sm:text-sm iphone:text- leading-10'>Di <span className='font-bold text-[#137fb8]'>Shelter</span>, 
                pengunjung dapat menikmati suasana <span className='font-bold text-[#137fb8]'>alam</span> di gunung galunggung dengan berbagai nuansa alam dan pemandangan kota Tasik. 
                <br />di Shelter juga terdapat <span className='font-bold text-[#137fb8]'>cafe</span> yang sering dikunjungi pengunjung untuk menikmati suasana alam  
                </p>
        </div>
        </section>
        <section className='h-[100vh] tablet:h-[60vh] android:h-[30vh]'>
        <iframe className='w-full h-full' src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Shelter%20galunggung+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/">gps systems</a></iframe>
        </section>
    </>
  )
}
