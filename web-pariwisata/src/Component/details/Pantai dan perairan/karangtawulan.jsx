...
import '../../../App.css';
import tw1 from "../../../Images/karangtawulan/tw2.png";
import tw2 from "../../../Images/karangtawulan/TW1.JPG";
import tw3 from "../../../Images/karangtawulan/tw3.png";
import tw4 from "../../../Images/karangtawulan/tw4.png";
import tw5 from "../../../Images/karangtawulan/tw5.png";
import tw6 from "../../../Images/karangtawulan/tw6.png";
import tw7 from "../../../Images/karangtawulan/tw7.png";
...
const Karangtawulan = () => {
  ...
  return (
    <>
        <section style={{
                        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${tw2})`,
            ...
            <div>
              <a target='blank' 
              href='https://maps.app.goo.gl/HcgHyqWqSTQMc9qz6' 
            ...
            <div className='flex flex-col gap-5 iphone:gap-3  items-end px-[10%]'>
              <h1 className='font-extrabold text-9xl tablet-sm:text-7xl android:text-6xl android-sm:text-4xl iphone:text-3xl'>KARANG TAWULAN</h1>
        ...
        <div style={{
          ...
          <div className='bg-[#004194] p-10 bg-opacity-40 tablet:h-full'>
            ...
            <h2 className=' ml-5 mt-3 iphone:mt-0'>KARANG TAWULAN</h2>
          </div>
        </div>
        <div className='w-[70vw] tablet:w-full h-[100vh]  py-[10%] px-[10%] text-[#505050]'>
              <h1 className='text-6xl mb-2 title font-semibold text-[#137fb8] tablet-sm:text-5xl android:text-4xl android-sm:text-2xl iphone:text-xl'>KARANG TAWULAN</h1>
              <p className='text-3xl tablet-sm:text-xl android:text-lg android-sm:text-sm iphone:text- leading-10'>Pantai <span className='font-bold text-[#137fb8]'>Karang Tawulan</span> di <span className='font-bold text-[#137fb8]'>Tasikmalaya</span> memiliki pemandangan yang sangat unik dan menakjubkan. 
              Salah satu fun fact mengenai pantai ini adalah bahwa Pantai Karang Tawulan dikenal sebagai 
              <span className='font-bold text-[#137fb8]'> "Tanah Lot-nya Tasikmalaya."</span> Ini karena pantai ini memiliki formasi batu karang yang menyerupai 
              <span className='font-bold text-[#137fb8]'> Pura Tanah Lot</span> di Bali, yang memberikan pemandangan spektakuler terutama saat matahari terbenam.</p>
        </div>
        </section>
        <section className='h-[100vh] tablet:h-[60vh] android:h-[30vh]'>
        <iframe className='w-full h-full' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.777643166731!2d108.29718227575046!3d-7.813346677583955!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e65c477a965ff9b%3A0xe1bf7e524db488ef!2sPantai%20Karang%20Tawulan!5e0!3m2!1sid!2sid!4v1725024016276!5m2!1sid!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </section>
    </>
  )
}

export default Karangtawulan
